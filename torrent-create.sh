...
sudo chmod 755 -R "$APP_DIR/sources"

if sudo transmission-create -o "$APP_DIR/torrents/$OUTPUT_FILENAME" -t "$TRACKER_URL_UDP" "$APP_DIR/sources/$1" > /dev/null 2>&1
  ...
  then
    sudo chmod 755 -R "$APP_DIR/torrents"
